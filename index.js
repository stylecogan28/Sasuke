...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const adminbotnumber = ["+62 877-6025-6426@s.whatsapp.net"]
			const frendsowner = ["+62 881-0238-59786@s.whatsapp.net"]
			const isGroup =  "https://chat.whatsapp.com/I5tzLcxHis75IMvPyhVgbl"
			...
			case 'creator':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'tagme':
					...
					const tag = {
					text: `@${nom.split("@s.whatsapp.net")[0]} Hay sayangku yg manis🤗`,
